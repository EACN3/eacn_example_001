...
- **research_hub_mcp** — CrossRef（1.3亿+论文）、SSRN、Semantic Scholar 等，智能路由 — github.com/Ladvien/research_hub_mcp
...
- **Jina AI MCP** — URL 转 Markdown、网页搜索、嵌入 — github.com/jina-ai/MCP

### 知识图谱
- **mcp-neo4j-memory** — Neo4j 持久化知识图谱：实体、观察、关系的语义检索 — github.com/neo4j-contrib/mcp-neo4j
