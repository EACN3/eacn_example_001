...
- **math-mcp** — SymPy + SciPy 符号与数值计算 — github.com/codeprimate/math-mcp
...
### 形式化证明
- **lean-lsp-mcp** — Lean 4 语言服务器，实时证明状态反馈 — Leanstral 项目
- **mcp-coq-lsp** — Coq 证明助手 MCP 接口 — github.com/scidonia/mcp-coq-lsp
